...
typeof window !== "undefined" && window.__ModuleLoader__ && window.__ModuleLoader__.load({
	...
	factory: (require) => {
		  ...
		  return (0, import_react_dom.createPortal)(
		    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
		      "div",
		      {
		        ...
		        children: [
		          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EdgeCue, { direction: "older", shown: window_.hasOlder }),
		          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { className: "dms-ruler", role: "list", onMouseLeave: () => setHoverTurn(null), children: window_.visible.map((tick) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		            Tick,
		            {
		              tick,
		          ...
		          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EdgeCue, { direction: "newer", shown: window_.hasNewer })
		        ]
		      }
		    ),
		    host
		...
		var NEAR_RADIUS = 2;
		function isNear(ticks, turn, activeTurn) {
		...
		function Tick({ tick, active, near, hovered, onHover, onJump, t, now }) {
		  const reason = reasonLabel(t, tick);
		  const time = relativeTime(tick.time, now);
		  const summary = tick.summary ?? null;
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { className: "dms-tickWrap", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
		    "button",
		    {
		      type: "button",
		      role: "listitem",
		      ...
		      "data-near": near && !active ? "1" : void 0,
