...
typeof window !== "undefined" && window.__ModuleLoader__ && window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var WINDOW_RADIUS = 1;
		var VISIBLE_RADIUS = 4;
		var VISIBLE_TICKS = VISIBLE_RADIUS * 2 + 1;
		var STRIP_OVERSCAN = 2;
		var STRIP_TICKS = VISIBLE_TICKS + STRIP_OVERSCAN * 2;
		var WINDOW_TICKS = VISIBLE_TICKS;
		var EMPHASIS_FOCUS = 0;
		var EMPHASIS_NEAR = 1;
		var EMPHASIS_NORMAL = 2;
		function emphasisOf(distance) {
